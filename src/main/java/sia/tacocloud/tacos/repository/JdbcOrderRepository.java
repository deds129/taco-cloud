...
public class JdbcOrderRepository implements OrderRepository {
	...
	public TacoOrder save(TacoOrder order) {
		...
		//создания объекта PreparedStatementCreator, передавая значения из объекта TacoOrder
		...
		//получаем значение id, назанченное базой данных. Сетим значение в id TacoOrder
		long orderId = keyHolder.getKey().longValue();
		order.setId(orderId);
		List<Taco> tacos = order.getTacos();
		int i=0;
		for (Taco taco : tacos) {
			//cохранения объектов Taco связанных с TacoOrder
